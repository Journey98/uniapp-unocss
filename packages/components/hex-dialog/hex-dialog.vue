<template>
  <view>
    ...
    >
      <view class="hex-model">
        <view
          v-if="title"
          class="hex-model__title hex-line-1"
          :style="[titleStyle]"
        >
          {{ title }}
        </view>
        <view class="hex-model__content">
          <scroll-view
            class="hex-model__content__scroll-view"
            scroll-y="true"
            :style="{ maxHeight: scrollMaxHeight + 'rpx' }"
          >
            <view
              :style="[contentStyle]"
            ...
            <view
              v-else
              class="hex-model__content__message"
              :class="{
                'hex-model__content__message__title': title.length > 0,
              }"
              :style="[contentStyle]"
              v-html="content"
            >
        ...
        <view
          class="hex-model__footer hex-border-top"
          v-if="showCancelButton || showConfirmButton"
        >
          <view
            v-if="showCancelButton"
            :hover-stay-time="100"
            hover-class="hex-model__btn--hover"
            class="hex-model__footer__button"
          ...
          <view
            ...
            :hover-stay-time="100"
            :hover-class="asyncClose ? 'none' : 'hex-model__btn--hover'"
            class="hex-model__footer__button hairline-left"
 ...
 * @example <hex-dialog :src="title" :content="content"></hex-dialog>
 */
export default {
  name: "hex-dialog",
...
.hex-model {
  ...
  .hairline-left {
    border-left: 1rpx solid $hex-border-color;
  }
}
</style>
